...
bool communication__msg__battery_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("communication.msg._battery_states.BatteryStates", full_classname_dest, 47) == 0);
  }
  communication__msg__BatteryStates * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BatteryStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("communication.msg._battery_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BatteryStates");
