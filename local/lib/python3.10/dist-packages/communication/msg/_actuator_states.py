...
class Metaclass_ActuatorStates(type):
    """Metaclass of message 'ActuatorStates'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'communication.msg.ActuatorStates')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__actuator_states
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__actuator_states
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__actuator_states
            cls._TYPE_SUPPORT = module.type_support_msg__msg__actuator_states
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__actuator_states
...
class ActuatorStates(metaclass=Metaclass_ActuatorStates):
    """Message class 'ActuatorStates'."""
    ...
    _fields_and_field_types = {
        ...
        'driver_temperature': 'sequence<double>',
        'motor_temperature': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.driver_temperature = array.array('d', kwargs.get('driver_temperature', []))
        self.motor_temperature = array.array('d', kwargs.get('motor_temperature', []))
    ...
    def driver_temperature(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'driver_temperature' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'driver_temperature' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._driver_temperature = array.array('d', value)
    ...
    def motor_temperature(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'motor_temperature' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'motor_temperature' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._motor_temperature = array.array('d', value)
